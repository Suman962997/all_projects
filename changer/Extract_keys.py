...
Performance of the entity against the specific commitments, goals and targets
...
KEYS_TO_EXTRACT_C1="""
Details of fines / penalties /punishment/ award/ compounding fees/ settlement
Does the entity have an anti-corruption or anti-bribery policy
Provide details of any corrective action taken or underway on issues related
Does the entity have processes in place to avoid/ manage conflict of interests involving members
"""
...
Does the entity have a framework/policy on cyber security and risks related to data privacy? (Yes/No). If available, provide weblink of the policy.
