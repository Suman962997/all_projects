...
Turnover_rate_for_permanent ={
    ...
    "columns":{
        "Category":["Category",''," "],
        "FY (2024-25) Male":["FY (2024-25) Male","Financial Year 2023-24 Male","Financial Year 2023-24 (Turnover rate in current FY) Male"],
        "FY (2024-25) Female":["FY (2024-25) Female","Financial Year 2022-23 Female","Financial Year 2022-23 (Turnover rate in current FY) Female"],
        "FY (2024-25) Total":["FY (2024-25) Total","Financial Year 2021-22 Total","Financial Year 2021-22 (Turnover rate in current FY) Total"],
        "FY (2023-24) Male":["FY (2023-24) Male","Financial Year (2023-24) Male","Financial Year (2023-24) (Turnover rate in previous FY) Male"],
        "FY (2023-24) Female":["FY (2023-24) Female","Financial Year (2023-24) Female","Financial Year (2023-24) (Turnover rate in previous FY) Female"],
        "FY (2023-24) Total":["FY (2023-24) Total","Financial Year (2023-24) Total","Financial Year (2023-24) (Turnover rate in previous FY) Total"],
        "FY (2022-23) Male":["FY (2022-23) Male","Financial Year (2022-23) Male","Financial Year (2022-23) (Turnover rate in the year priorto previous FY) Male"],
        "FY (2022-23) Female":["FY (2022-23) Female","Financial Year (2022-23) Female","Financial Year (2022-23) (Turnover rate in the year priorto previous FY) Female"],
        "FY (2022-23) Total":["FY (2022-23) Total","Financial Year (2022-23) Total","Financial Year (2022-23) (Turnover rate in the year priorto previous FY) Total"], 
    }
...
Names_of_holding={
    ...
    "columns":{
            "Name of the holding / subsidiary / associate companies / joint ventures (A)":["Name of the holding / subsidiary / associate companies / joint ventures (A)","Name of the holding / subsidiary / associate"],
            "Indicate whether holding/ Subsidiary/ Associate/ Joint Venture":["Indicate whether holding/ Subsidiary/ Associate/ Joint Venture","Indicate whether"],
            "% of shares held by listed entity":["% of shares held by listed entity","% of shares held by listed entity"],
            "Does the entity indicated at column A, participate in the Business Responsibility initiatives of the listed entity? (Yes/ No)":["Does the entity indicated at column A, participate in the Business Responsibility initiatives of the listed entity?","Does the entity indicated at column A, participate in the Business Responsibility initiatives of the listed entity? (Yes/No)"]        
    }
