...
Whether_your_entity={
    ...
    "columns":{   
            ...
            "P3":["P3","P 3","Principle 3"],
            "P4":["P4","P 4","Principle 4"],
            "P5":["P5","P 5","Principle 5"],
            "P6":["P6","P 6","Principle 6"],
            "P7":["P7","P 7","Principle 7"],
            "P8":["P8","P 8","Principle 8"],
            "P9":["P9","P 9","Principle 9"]
    } 
}
...
Frequency_Annually_Half_yearly={
