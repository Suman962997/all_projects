...
const SectionC: React.FC<SectionCProps> = ({putdata,selectedindex,editOnly}) => {
    ...
    const [principleKey,setPrincipleKey] = useState<string>("");
...
const question = generateQuestion(text);
        ...
        'section_c': {
            ...
            'seven': {
                ...
                questionMap: {
                    ...
                    '2': 'List the top 10 trade and industry chambers/associations (determined based on the total members of such body) the entity is a member of/affiliated to',
    ...
    const transformApiResponseToAnswers = (apiData: any[]) => {
        ...
        apiData.forEach((section: any) => {
            ...
            // console.log(sectionPartMap[sectionName] )
...
//   };
    ...
    const handleFileUpload = async (info: any, questionKey: string,principleKey:string) => {
        ...
        try {
            ...
            const filename=responseData.brsrfilename
            ...
            const apiData = Array.isArray(responseData.response.data)
            ...
            setRdata(extractQA(responseData.response))
...
const handleCategoryClick = (categoryKey: string, id: number) => {
    console.log(categoryKey,id,'yyyyyy')
//   if (!pdf) {
...
// console.log(principleKey)
    ...
    //     console.log("section",section)
    // console.log("wdedeeff",section,key,questionIndex)
